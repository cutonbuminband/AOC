...
#+begin_src jupyter-python
  ...
  inputs = [1]
  while program[ip] != 99:
      program, ip, _ = step(program, ip, inputs)
#+end_src
...
#+begin_src jupyter-python
  ...
  ip = 0
  while part1[ip] != 99:
      part1, ip, relative_base = step(part1, ip, inputs=[1], relative_base=relative_base)
#+end_src
...
#+begin_src jupyter-python
  ...
  part2 = program
  while part2[ip] != 99:
      part2, ip, relative_base = step(part2, ip, inputs=[2], relative_base=relative_base)
#+end_src
