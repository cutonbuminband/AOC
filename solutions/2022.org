...
#+begin_src jupyter-python
  lines = [
      ...
      for x, y in [x.strip().split() for x in load(2)]
  ]
...
** Part 1
#+begin_src jupyter-python
  assignments = [x.strip() for x in load(4)]
  regex = re.compile("\d+")
...
** Part 1
#+begin_src jupyter-python
  lines = [line.strip() for line in load(5)]
...
#+begin_src jupyter-python
  lines = [line.strip() for line in load(7)]
...
** Part 1
#+begin_src jupyter-python
  data = [list(x.strip()) for x in load(12)]
